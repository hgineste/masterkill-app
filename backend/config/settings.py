...
DATABASES = {
    'default': dj_database_url.config(
        default=f"sqlite:///{BASE_DIR / 'db.sqlite3'}", # Fallback pour dev local si DATABASE_URL n'est pas définie
        conn_max_age=600,
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    # "https://VOTRE_URL_FRONTEND_NETLIFY.netlify.app", # À décommenter et remplir plus tard
]
# Pour le débogage CORS uniquement, si absolument nécessaire :
